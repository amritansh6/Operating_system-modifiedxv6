   ...
   e:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  21:	50                   	push   %eax
  22:	50                   	push   %eax
  23:	68 68 07 00 00       	push   $0x768
  28:	6a 02                	push   $0x2
  2a:	e8 e1 03 00 00       	call   410 <printf>
    exit();
...
printf(int fd, char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 88 07 00 00       	mov    $0x788,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 34 0a 00 00       	mov    0xa34,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 34 0a 00 00    	mov    0xa34,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 47                	jae    708 <malloc+0x98>
    ...
    if(p == freep)
 6c1:	39 05 34 0a 00 00    	cmp    %eax,0xa34
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
  return freep;
 6eb:	8b 15 34 0a 00 00    	mov    0xa34,%edx
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 717:	89 15 34 0a 00 00    	mov    %edx,0xa34
}
 ...
 729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 737:	0a 00 00 
 73a:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 741:	0a 00 00 
    base.s.size = 0;
 744:	b8 38 0a 00 00       	mov    $0xa38,%eax
 749:	c7 05 3c 0a 00 00 00 	movl   $0x0,0xa3c
 750:	00 00 00 
