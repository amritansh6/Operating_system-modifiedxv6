...
main(int argc, char *argv[])
{
   ...
   f:	8d 9d f8 fd ff ff    	lea    -0x208(%ebp),%ebx
{
  15:	81 ec 08 02 00 00    	sub    $0x208,%esp
    getcwd(path, MAX_PATH);
  1b:	68 00 02 00 00       	push   $0x200
  20:	53                   	push   %ebx
  21:	e8 14 03 00 00       	call   33a <getcwd>
    printf(0, "%s\n", path);
  26:	83 c4 0c             	add    $0xc,%esp
  29:	53                   	push   %ebx
  2a:	68 48 07 00 00       	push   $0x748
  2f:	6a 00                	push   $0x0
  31:	e8 ba 03 00 00       	call   3f0 <printf>
    exit();
...
free(void *ap)
{
 ...
 5c1:	a1 fc 09 00 00       	mov    0x9fc,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 fc 09 00 00       	mov    %eax,0x9fc
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 fc 09 00 00       	mov    %eax,0x9fc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 fc 09 00 00    	mov    0x9fc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 fc 09 00 00    	mov    %edx,0x9fc
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 fc 09 00 00 00 	movl   $0xa00,0x9fc
 717:	0a 00 00 
 71a:	c7 05 00 0a 00 00 00 	movl   $0xa00,0xa00
 721:	0a 00 00 
    base.s.size = 0;
 724:	b8 00 0a 00 00       	mov    $0xa00,%eax
 729:	c7 05 04 0a 00 00 00 	movl   $0x0,0xa04
 730:	00 00 00 
